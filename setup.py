...
def update_version_py():
    ...
    try:
        ...
        print("unable to run git, leaving natto/_version.py alone")
        return
    ...
    f = open("natto/_version.py", "w")
    f.write(VERSION_PY % ver)
    f.close()
    print("set natto/_version.py to '%s'" % ver)


def get_version():
    try:
        f = open("natto/_version.py")
    except EnvironmentError:
        return None
...
setup(
    ...
    author_email='myl4stn4m3@cs.uni-freiburg.de',
        packages=['natto','natto.input', 'natto.process', 'natto.out','natto.process.cluster'],
    scripts=[ ],
    include_package_data=True,
    package_data={},
    url='https://github.com/smautner/natto',
    license='LICENSE',
